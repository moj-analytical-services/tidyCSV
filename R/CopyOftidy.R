...
test1 <- tidy("Adjudications2016.csv","2016")
test2 <- tidy("Adjudications-2017(Rev).xlsx","2017")
test3 <- tidy("Adjudications2018.csv","2018")
test4 <- tidy("Adjudications Q1 2019.csv","2019")
test5 <- tidy("Adjudications Q2 2019.csv","2019")

test <- bind_rows(test2,test3, test4,test5)
